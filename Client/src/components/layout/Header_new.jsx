      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center lg:hidden">
          <button
            ...
            className="mr-3 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors"
        ...
        <h1 className="hidden lg:flex text-2xl font-bold text-teal-500 items-center">
          ...
          {userInfo?.isLoggedIn ? (
            <div className="flex items-center gap-2">
              <div className="hidden md:block text-right">
                <p className="text-sm font-medium">{userInfo.displayName?.split('@')[0]}</p>
